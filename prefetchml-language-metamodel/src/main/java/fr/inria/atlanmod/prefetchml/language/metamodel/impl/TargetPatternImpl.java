 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.prefetchml.language.metamodel.impl.TargetPatternImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link fr.inria.atlanmod.prefetchml.language.metamodel.impl.TargetPatternImpl#getEClass <em>EClass</em>}</li>
 *   <li>{@link fr.inria.atlanmod.prefetchml.language.metamodel.impl.TargetPatternImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TargetPatternImpl extends MinimalEObjectImpl.Container implements TargetPattern {
	...
	public EList<FeaturePattern> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<FeaturePattern>(FeaturePattern.class, this, PrefetchingPackage.TARGET_PATTERN__FEATURES);
		}
		return features;
	}
