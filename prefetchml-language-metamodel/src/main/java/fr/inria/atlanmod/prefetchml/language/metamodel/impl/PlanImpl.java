...
import fr.inria.atlanmod.prefetchml.language.metamodel.AfterClause;
 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.prefetchml.language.metamodel.impl.PlanImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.inria.atlanmod.prefetchml.language.metamodel.impl.PlanImpl#getAfter <em>After</em>}</li>
 *   <li>{@link fr.inria.atlanmod.prefetchml.language.metamodel.impl.PlanImpl#getRules <em>Rules</em>}</li>
 *   <li>{@link fr.inria.atlanmod.prefetchml.language.metamodel.impl.PlanImpl#getCache <em>Cache</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlanImpl extends MinimalEObjectImpl.Container implements Plan {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrefetchingPackage.PLAN__NAME, oldName, name));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAfter(AfterClause newAfter, NotificationChain msgs) {
		AfterClause oldAfter = after;
		after = newAfter;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setAfter(AfterClause newAfter) {
		if (newAfter != after) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PrefetchingPackage.PLAN__NAME:
				return getName();
			case PrefetchingPackage.PLAN__AFTER:
				return getAfter();
			case PrefetchingPackage.PLAN__RULES:
