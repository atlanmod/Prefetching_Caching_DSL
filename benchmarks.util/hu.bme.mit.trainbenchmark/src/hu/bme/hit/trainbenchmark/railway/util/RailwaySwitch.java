...
public class RailwaySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RailwayPackage.SWITCH: {
				hu.bme.hit.trainbenchmark.railway.Switch switch_ = (hu.bme.hit.trainbenchmark.railway.Switch)theEObject;
	 ...
	 * @generated
	 */
	public T caseSwitch(hu.bme.hit.trainbenchmark.railway.Switch object) {
		return null;
	}
