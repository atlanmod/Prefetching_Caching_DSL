 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.hit.trainbenchmark.railway.TrackElement#getMonitoredBy <em>Monitored By</em>}</li>
 *   <li>{@link hu.bme.hit.trainbenchmark.railway.TrackElement#getConnectsTo <em>Connects To</em>}</li>
 * </ul>
 *
 * @see hu.bme.hit.trainbenchmark.railway.RailwayPackage#getTrackElement()
 * @model abstract="true"
 * @generated
 */
public interface TrackElement extends RailwayElement {
	 ...
	 * It is bidirectional and its opposite is '{@link hu.bme.hit.trainbenchmark.railway.Sensor#getMonitors <em>Monitors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see hu.bme.hit.trainbenchmark.railway.RailwayPackage#getTrackElement_MonitoredBy()
	 ...
	 * @see hu.bme.hit.trainbenchmark.railway.RailwayPackage#getTrackElement_ConnectsTo()
	 * @model
	 * @generated
	 */
