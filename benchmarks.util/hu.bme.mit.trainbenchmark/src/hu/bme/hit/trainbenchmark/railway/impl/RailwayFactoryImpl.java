...
public class RailwayFactoryImpl extends EFactoryImpl implements RailwayFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RailwayPackage.SEGMENT: return (EObject)createSegment();
			case RailwayPackage.SWITCH: return (EObject)createSwitch();
			case RailwayPackage.ROUTE: return (EObject)createRoute();
			case RailwayPackage.SEMAPHORE: return (EObject)createSemaphore();
			case RailwayPackage.SWITCH_POSITION: return (EObject)createSwitchPosition();
			case RailwayPackage.SENSOR: return (EObject)createSensor();
			case RailwayPackage.RAILWAY_CONTAINER: return (EObject)createRailwayContainer();
			case RailwayPackage.REGION: return (EObject)createRegion();
			default:
