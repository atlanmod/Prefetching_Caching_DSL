 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.neoemf.prefetching.impl.PrefetchingRuleImpl#getMoment <em>Moment</em>}</li>
 *   <li>{@link fr.inria.atlanmod.neoemf.prefetching.impl.PrefetchingRuleImpl#getSourcePattern <em>Source Pattern</em>}</li>
 *   <li>{@link fr.inria.atlanmod.neoemf.prefetching.impl.PrefetchingRuleImpl#getTargetPattern <em>Target Pattern</em>}</li>
 *   <li>{@link fr.inria.atlanmod.neoemf.prefetching.impl.PrefetchingRuleImpl#getProbability <em>Probability</em>}</li>
 *   <li>{@link fr.inria.atlanmod.neoemf.prefetching.impl.PrefetchingRuleImpl#getSubRules <em>Sub Rules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrefetchingRuleImpl extends MinimalEObjectImpl.Container implements PrefetchingRule
{
   ...
   * @ordered
   */
  protected static final Moment MOMENT_EDEFAULT = Moment.ON_STARTING;
  ...
  public void setMoment(Moment newMoment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PrefetchingPackage.PREFETCHING_RULE__MOMENT, oldMoment, moment));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PrefetchingPackage.PREFETCHING_RULE__MOMENT:
        return getMoment();
      case PrefetchingPackage.PREFETCHING_RULE__SOURCE_PATTERN:
