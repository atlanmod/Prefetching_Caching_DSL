 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.neoemf.prefetching.FilterPattern#getStringPattern <em>String Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.inria.atlanmod.neoemf.prefetching.PrefetchingPackage#getFilterPattern()
 * @model
 * @generated
 */
public interface FilterPattern extends EObject
{
   ...
   * @see fr.inria.atlanmod.neoemf.prefetching.PrefetchingPackage#getFilterPattern_StringPattern()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.inria.atlanmod.neoemf.prefetching.FilterPattern#getStringPattern <em>String Pattern</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
