...
public class AbstractTestCaseNoPrefetchMapDB extends AbstractPrefetchTest {
    ...
    public AbstractTestCaseNoPrefetchMapDB(String resourceName, String scriptSuffix) {
