...
public abstract class AbstractTestCasePrefetchEMFCDO extends AbstractPrefetchTest {
    ...
    public AbstractTestCasePrefetchEMFCDO(String resourceName, String scriptSuffix) {
