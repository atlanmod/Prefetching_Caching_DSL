 ...
 * NeoEMF resource. EMF-based prefetching is enabled.
 * <p>
 ...
 *
 */
public class ClassToUnitTestPrefetchEMF extends EMFPrefetchJavaTestNeoEMF {
	
    private static final String SCRIPT_NAME = "Q2";
    
    /**
     * Constructs a new {@link ClassToUnitTestPrefetchEMF} with the given
     ...
     * 
     */
    public ClassToUnitTestPrefetchEMF(String resourceName, String xmiLocation, String scriptSuffix,
            String resourceType) {
