 ...
 *
 */
public class ConnectedSegmentsTestPrefetchEMF extends EMFPrefetchRailwayTestNeoEMF {
	
    private static final String SCRIPT_NAME = "CollectRailway";
    
    /**
     * Constructs a new {@link ConnectedSegmentsTestPrefetchEMF} with the given
     ...
     * 
     */
	public ConnectedSegmentsTestPrefetchEMF(String resourceName, String xmiLocation,
