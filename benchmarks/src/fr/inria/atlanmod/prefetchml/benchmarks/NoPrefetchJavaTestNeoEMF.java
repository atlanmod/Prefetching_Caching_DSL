 ...
 *
 */
public abstract class NoPrefetchJavaTestNeoEMF extends AbstractJavaTestNeoEMF { 
    
    /**
     * Constructs a new {@link NoPrefetchJavaTestNeoEMF} with the given
     ...
     * 
     */
    public NoPrefetchJavaTestNeoEMF(String resourceName, String xmiLocation, String scriptSuffix, String resourceType) {
