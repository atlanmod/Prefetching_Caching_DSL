...
public class BlockStatementTestNoPrefetchMapDB extends AbstractTestCaseNoPrefetchMapDB {
	
	public BlockStatementTestNoPrefetchMapDB(String resourceName, String scriptSuffix) {
