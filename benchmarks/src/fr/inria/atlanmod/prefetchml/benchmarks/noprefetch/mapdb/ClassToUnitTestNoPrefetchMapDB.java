...
public class ClassToUnitTestNoPrefetchMapDB extends AbstractTestCaseNoPrefetchMapDB {
	
	public ClassToUnitTestNoPrefetchMapDB(String resourceName, String scriptSuffix) {
