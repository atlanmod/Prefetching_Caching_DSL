...
public class RouteSensorRailwayTestPrefetchEMFMapDB extends AbstractTestCaseRailwayPrefetchEMFMapDB {
	
	public RouteSensorRailwayTestPrefetchEMFMapDB(String resourceName, String scriptSuffix) {
    ...
    protected String getScriptString() {
    	return "plans/bin/RouteSensorsRailway";
    }
