...
public abstract class EMFPrefetchJavaTestCDO extends AbstractJavaTestCDO {
    ...
    /**
     * Constructs a new {@link EMFPrefetchJavaTestCDO} with the given
     ...
     * 
     */
    public EMFPrefetchJavaTestCDO(String resourceName, String xmiLocation, String scriptSuffix,
            String resourceType) {
