...
public abstract class EMFPrefetchRailwayTestNeoEMF extends AbstractRailwayTestNeoEMF{
    ...
    /**
     * Constructs a new {@link EMFPrefetchRailwayTestNeoEMF} with the given
     ...
     * 
     */
    public EMFPrefetchRailwayTestNeoEMF(String resourceName, String xmiLocation, String scriptSuffix,
            String resourceType) {
    ...
    public void setUp() throws Exception {
        super.setUp();
        prefetchRuntime = new EMFPrefetcherRuntime(resource);
