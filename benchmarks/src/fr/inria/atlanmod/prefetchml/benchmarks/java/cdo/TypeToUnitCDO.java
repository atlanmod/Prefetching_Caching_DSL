 ...
 *
 */
public class TypeToUnitCDO extends AbstractJavaTestCDO {

    private static final String SCRIPT_NAME = "Q1";

    /**
     * Constructs a new {@link TypeToUnitCDO} with the given
     ...
     * 
     */
    public TypeToUnitCDO(String resourceName, String xmiLocation, String scriptSuffix,
            String resourceType) {
