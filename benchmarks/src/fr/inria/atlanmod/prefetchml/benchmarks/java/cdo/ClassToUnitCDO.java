 ...
 *
 */
public class ClassToUnitCDO extends AbstractJavaTestCDO {

    private static final String SCRIPT_NAME = "Q2";

    /**
     * Constructs a new {@link ClassToUnitCDO} with the given
     ...
     * 
     */
    public ClassToUnitCDO(String resourceName, String xmiLocation,
    ...
    protected List<EClass> getQueryContexts() {
        return Arrays.asList(new EClass[]{JavaPackage.eINSTANCE.getClassDeclaration()});
    }

    @Override
    protected List<String> getTextualQueries() {
        return Arrays.asList(new String[]{QueryUtil.getClassToUnitQuery()});
    }
