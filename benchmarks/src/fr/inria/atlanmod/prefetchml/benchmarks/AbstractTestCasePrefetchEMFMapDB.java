...
public abstract class AbstractTestCasePrefetchEMFMapDB extends AbstractPrefetchTest {
    ...
    public AbstractTestCasePrefetchEMFMapDB(String resourceName, String scriptSuffix) {
