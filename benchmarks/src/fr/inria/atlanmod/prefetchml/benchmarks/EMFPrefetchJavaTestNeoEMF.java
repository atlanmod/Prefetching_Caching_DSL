...
public abstract class EMFPrefetchJavaTestNeoEMF extends AbstractJavaTestNeoEMF {
    ...
    /**
     * Constructs a new {@link EMFPrefetchJavaTestNeoEMF} with the given
     ...
     * 
     */
    public EMFPrefetchJavaTestNeoEMF(String resourceName, String xmiLocation, String scriptSuffix,
            String resourceType) {
