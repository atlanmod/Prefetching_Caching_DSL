...
public class StartingPackageOwnedPackagesTest {
	...
	public void test() throws Exception {
		...
		runtime.loadPrefetchScript(URI.createURI("startingPackageOwnedPackages.prefetch.bin"),r);
		...
		((EList<EObject>)result).get(0).eGet(jPackage.getPackage_OwnedPackages());
		synchronized (this) {
			wait(1000000);
		}
